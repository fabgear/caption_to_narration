...
# ===============================================================
# ▼▼▼ ツールの本体（エンジン部分）- （ver3.5：N強制挿入ロジック追加）▼▼▼
# ===============================================================
...
# ===============================================================
# ▼▼▼ Streamlitの画面を作る部分 - （ver3.5：UI安定化と下部機能追加）▼▼▼
# ===============================================================
...
with col2_main:
    # st.empty() を使用して、プレースホルダーを定義
    output_text_area = st.empty()


# ----------------------------------------------------------------------------------
# 2. 下部：コントロールエリア（ver3の機能本体）
# ----------------------------------------------------------------------------------
col1_bottom, col2_bottom = st.columns(2)

# ▼▼▼【ver3.5 変更点】コントロールエリアでチェックボックスを定義 ▼▼▼
with col1_bottom:
    n_force_insert = st.checkbox("N強制挿入", value=True)

with col2_bottom:
    # 右下のエリアは空で、左下のチェックボックスに合わせた高さ調整の役割
    # 今回は高さを調整する要素を意図的に配置しない
    pass
