...
# ===============================================================
# ▼▼▼ Streamlitの画面を作る部分 - 【HTML/CSSでUIを完全再現】▼▼▼
# ===============================================================
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
    <p style="margin: 0; padding: 0;">ナレーション原稿形式に変換します</p>
...
# --- ▼▼▼【変更点】JavaScriptを使って、Streamlitが生成するチェックボックスを、HTMLで作った場所に移動させます ▼▼▼ ---
st.components.v1.html("""
    <script>
        // Streamlitが要素をレンダリングするのを少し待つ
        const checkExist = setInterval(function() {{
           ...
           if (checkbox && container) {{
              ...
              clearInterval(checkExist); // 成功したら監視をやめる
           }}
        }}, 100); // 0.1秒ごとにチェック
    </script>
""", height=0)
